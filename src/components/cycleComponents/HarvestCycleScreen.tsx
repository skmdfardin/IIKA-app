                ...
                <View style={PageStyles.scroll}>
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: windowHeight * 0.04 }}>
                            ...
                            <View style={{ flexDirection: 'column', height: windowHeight * 0.05, alignSelf: 'flex-end', marginLeft: windowWidth * 0.5 }}>

                                <Text style={{ fontSize: 11, color: 'black', marginLeft: windowWidth * 0.03, fontWeight: '800' }}>#cycleID</Text>
